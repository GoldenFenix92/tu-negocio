                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="fs-4 fw-semibold mb-0"><?php echo e($dailyTotals['total_sales']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="fs-4 fw-semibold mb-0">$<?php echo e(number_format($expectedCashInRegister, 2)); ?></p>
                                    <?php if($initialCash > 0): ?>
                                    <p class="text-muted extra-small mb-0">Inicial: $<?php echo e(number_format($initialCash, 2)); ?></p>
                                    <?php endif; ?>
                                    <?php if($totalDeposits > 0): ?>
                                        <p class="text-success extra-small mb-0">Ingresos: $<?php echo e(number_format($totalDeposits, 2)); ?></p>
                                    <?php endif; ?>
                                    <?php if($totalWithdrawals > 0): ?>
                                        <p class="text-danger extra-small mb-0">Retiros: $<?php echo e(number_format($totalWithdrawals, 2)); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="fs-4 fw-semibold mb-0">$<?php echo e(number_format($dailyTotals['card_amount'], 2)); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="fs-4 fw-semibold mb-0">$<?php echo e(number_format($dailyTotals['total_amount'], 2)); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <?php if($lastCashCount): ?>
                                    <span class="badge 
                                        <?php if($lastCashCount->status === 'completed'): ?> 
                                            bg-success-subtle text-success-emphasis border-success-subtle
                                        <?php elseif($lastCashCount->status === 'pending'): ?> 
                                            bg-warning-subtle text-warning-emphasis border-warning-subtle
                                        <?php else: ?> 
                                            bg-danger-subtle text-danger-emphasis border-danger-subtle
                                        <?php endif; ?>">
                                        <?php echo e($lastCashCount->status_text); ?>
                            ...
                            <?php if($lastCashCount): ?>
                                <div class="vstack gap-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="small fw-medium"><?php echo e($lastCashCount->folio); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Esperado:</span>
                                        <span class="small fw-medium">$<?php echo e(number_format($lastCashCount->expected_cash, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Real:</span>
                                        <span class="small fw-medium">$<?php echo e(number_format($lastCashCount->actual_cash, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Diferencia:</span>
                                        <span class="small fw-medium 
                                            <?php if($lastCashCount->difference > 0): ?> text-success
                                            <?php elseif($lastCashCount->difference < 0): ?> text-danger
                                            <?php else: ?> text-secondary
                                            <?php endif; ?>">
                                            $<?php echo e(number_format($lastCashCount->difference, 2)); ?>

                                            <?php if($lastCashCount->difference > 0): ?> (Sobra)
                                            <?php elseif($lastCashCount->difference < 0): ?> (Falta)
                                            <?php else: ?> <?php endif; ?>
                                        </span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Fecha:</span>
                                        <span class="small fw-medium"><?php echo e($lastCashCount->created_at->format('d/m/Y H:i')); ?></span>
                                    </div>
                                </div>
                            <?php else: ?>
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <?php if($lastCashCut): ?>
                                    <span class="badge 
                                        <?php if($lastCashCut->status === 'open'): ?> 
                                            bg-success-subtle text-success-emphasis border-success-subtle
                                        <?php elseif($lastCashCut->status === 'closed'): ?> 
                                            bg-danger-subtle text-danger-emphasis border-danger-subtle
                                        <?php else: ?> 
                                            bg-warning-subtle text-warning-emphasis border-warning-subtle
                                        <?php endif; ?>">
                                        <?php echo e($lastCashCut->status_text); ?>
                            ...
                            <?php if($lastCashCut): ?>
                                <div class="vstack gap-2">
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Folio:</span>
                                        <span class="small fw-medium"><?php echo e($lastCashCut->folio); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Esperado:</span>
                                        <span class="small fw-medium">$<?php echo e(number_format($lastCashCut->expected_cash, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Real:</span>
                                        <span class="small fw-medium">$<?php echo e(number_format($lastCashCut->actual_cash, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Diferencia:</span>
                                        <span class="small fw-medium 
                                            <?php if($lastCashCut->difference > 0): ?> text-success
                                            <?php elseif($lastCashCut->difference < 0): ?> text-danger
                                            <?php else: ?> text-secondary
                                            <?php endif; ?>">
                                            $<?php echo e(number_format($lastCashCut->difference, 2)); ?>

                                            <?php if($lastCashCut->difference > 0): ?> (Sobra)
                                            <?php elseif($lastCashCut->difference < 0): ?> (Falta)
                                            <?php else: ?> <?php endif; ?>
                                        </span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted small">Fecha:</span>
                                        <span class="small fw-medium"><?php echo e($lastCashCut->created_at->format('d/m/Y H:i')); ?></span>
                                    </div>
                                    <?php if($lastCashCut->status === 'open'): ?>
                                        <div class="pt-2 mt-2 border-top">
                                            <button id="close-cash-cut-btn"
                                                    data-cash-cut-id="<?php echo e($lastCashCut->id); ?>"
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border h-100">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo e(route('cash_control.movement_form')); ?>" class="btn btn-warning w-100">
                    ...
                    <?php if($cashMovements->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $cashMovements->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="small fw-medium 
                                                <?php if($movement->type === 'withdrawal'): ?> text-danger
                                                <?php else: ?> text-success
                                                <?php endif; ?>">
                                                <?php echo e(ucfirst($movement->type === 'withdrawal' ? 'Retiro' : 'Ingreso')); ?>

                                            </td>
                                            <td class="small fw-medium">
                                                $<?php echo e(number_format($movement->amount, 2)); ?>
                                            ...
                                            <td class="text-muted small">
                                                <?php echo e($movement->user->name ?? 'N/A'); ?>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="<?php echo e(route('cash_control.reports')); ?>" class="btn btn-sm btn-outline-primary">
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $sales->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="small fw-medium">
                                                <?php echo e($sale->folio); ?>

                                            </td>
                                            <td class="text-muted small">
                                                <?php echo e($sale->client ? $sale->client->full_name : 'Cliente general'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            try {
                ...
                const hasActiveSession = <?php echo e($hasActiveSession ? 'true' : 'false'); ?>;
                ...
                cashCountForm.addEventListener('submit', function(e) {
                    ...
                    try {
                        ...
                        fetch('<?php echo e(route('cash_control.cash_count')); ?>', {
                            method: 'POST',
                            headers: {
                            ...
                            if (data.success) {
                                ...
                                if (data.ask_for_session_close) {
                                    if (confirm('¿Deseas cerrar la sesión de caja ahora?')) {
                                        fetch('<?php echo e(route('cash_sessions.close_active')); ?>', {
                                            method: 'POST',
                                            headers: {
                                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                                                'Accept': 'application/json',
                ...
                if (closeCashCutBtn) {
                    closeCashCutBtn.addEventListener('click', function() {
                        if (confirm('¿Estás seguro de que quieres cerrar el corte de caja? Esta acción no se puede deshacer.')) {
                            ...
                            const cashCutId = submitBtn.dataset.cashCutId || <?php echo e($lastCashCut->id ?? 'null'); ?>;

                            fetch(`<?php echo e(url('/cash-control/cash-cut')); ?>/${cashCutId}/close`, {
                                method: 'POST',
                                headers: {
                                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                                }
                ...
                cashCutForm.addEventListener('submit', function(e) {
                    ...
                    try {
                        ...
                        fetch('<?php echo e(route('cash_control.cash_cut')); ?>', {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                                'Accept': 'application/json',
...
<?php endif; ?>
<?php /**PATH E:\Proyectos Eliel\EBC-PV\resources\views/cash_control/index.blade.php ENDPATH**/ ?>