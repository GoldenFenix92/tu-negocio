                    ...
                    <div class="card mb-4" id="intro">
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                <strong><i class="bi bi-book"></i> Nota:</strong> Consulta también los manuales de <a href="<?php echo e(route('manual.show', 'usuario')); ?>">Usuario</a> y <a href="<?php echo e(route('manual.show', 'supervisor')); ?>">Supervisor</a>.
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\Proyectos Eliel\EBC-PV\resources\views/manuals/administrador.blade.php ENDPATH**/ ?>