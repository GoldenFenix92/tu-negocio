...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'btn-lg justify-content-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-lg justify-content-center']); ?>
...
<?php endif; ?>
        ...
        <div class="text-center mt-3">
            <?php if(Route::has('password.request')): ?>
                <a class="text-muted text-decoration-underline small" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH E:\Proyectos Eliel\EBC-PV\resources\views/auth/login.blade.php ENDPATH**/ ?>