...
<body>
    ...
    <?php if($lowStockProducts->count() > 0): ?>
        <div style="margin-bottom: 15px;">
            <strong>Total de productos con stock bajo:</strong> <?php echo e($totalProducts); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $lowStockProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center" style="color: red; font-weight: bold;"><?php echo e($product->current_stock); ?></td>
                        <td class="text-center"><?php echo e($product->min_stock); ?></td>
                    </tr>
...
<?php /**PATH E:\Proyectos Eliel\EBC-PV\resources\views/stock_alerts/pdf.blade.php ENDPATH**/ ?>