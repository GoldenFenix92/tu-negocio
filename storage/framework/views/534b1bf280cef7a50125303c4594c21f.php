...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input id="commission_percentage" name="commission_percentage" type="number" step="0.01" min="0" max="100" class="form-control" value="<?php echo e(old('commission_percentage', 0)); ?>" />
...
<?php endif; ?>
<?php /**PATH E:\Proyectos Eliel\EBC-PV\resources\views/users/create.blade.php ENDPATH**/ ?>