...
-- Fecha: 2025-12-08 23:08:33

-- Estructura de la tabla `appointment_items`
...
CREATE TABLE `appointment_items` (
  ...
  KEY `appointment_items_itemable_type_itemable_id_index` (`itemable_type`,`itemable_id`),
...
CREATE TABLE `appointments` (
  ...
  `status` enum('Pendiente','Anticipo','Pagado','Cancelado') NOT NULL DEFAULT 'Pendiente',
  `comments` text DEFAULT NULL,
  `deposit_type` enum('Efectivo','Transferencia') DEFAULT NULL,
  `deposit_amount` decimal(10,2) DEFAULT NULL,
  `deposit_folio` varchar(255) DEFAULT NULL,
  `total` decimal(10,2) NOT NULL DEFAULT 0.00,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `appointments_deposit_folio_unique` (`deposit_folio`),
...
INSERT INTO `cash_counts` (`id`, `folio`, `user_id`, `start_date`, `end_date`, `total_sales`, `total_amount`, `cash_amount`, `card_amount`, `transfer_amount`, `expected_cash`, `actual_cash`, `difference`, `notes`, `status`, `created_at`, `updated_at`, `cash_session_id`) VALUES (12, 'EBC-ARQ-2025-12-08-001', 3, '2025-12-08 15:42:13', '2025-12-08 15:42:13', 0, 0.00, 0.00, 0.00, 0.00, 200.00, 200.00, 0.00, NULL, 'completed', '2025-12-08 15:42:13', '2025-12-08 15:42:13', 28);
...
CREATE TABLE `cash_cuts` (
  ...
  `folio` varchar(50) NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  `cut_date` timestamp NULL DEFAULT NULL,
  `total_sales` int(11) NOT NULL DEFAULT 0,
  `total_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `cash_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `card_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
...
INSERT INTO `cash_cuts` (`id`, `folio`, `user_id`, `cut_date`, `total_sales`, `total_amount`, `cash_amount`, `card_amount`, `transfer_amount`, `expected_cash`, `actual_cash`, `difference`, `notes`, `status`, `secret_code`, `closed_at`, `closed_by`, `created_at`, `updated_at`, `cash_session_id`) VALUES (26, 'EBC-CRTE-2025-12-08-001', 3, '2025-12-08 15:42:31', 0, 0.00, 0.00, 0.00, 0.00, 200.00, 200.00, 0.00, NULL, 'closed', 'EBCADMIN', '2025-12-08 15:42:37', 3, '2025-12-08 15:42:31', '2025-12-08 15:42:37', 28);
...
CREATE TABLE `cash_sessions` (
  ...
  `voucher_count` int(11) NOT NULL DEFAULT 0,
  `voucher_folios` text DEFAULT NULL,
  `start_folio` varchar(255) DEFAULT NULL,
  `end_folio` varchar(255) DEFAULT NULL,
...
INSERT INTO `cash_sessions` (`id`, `user_id`, `initial_cash`, `total_sales`, `total_cash`, `total_card`, `voucher_count`, `voucher_folios`, `start_folio`, `end_folio`, `start_time`, `end_time`, `status`, `created_at`, `updated_at`) VALUES (28, 3, 200.00, 0.00, 0.00, 0.00, 0, NULL, 'EBC-VNTA-075', NULL, '2025-12-08 14:44:01', '2025-12-08 15:42:37', 'closed', '2025-12-08 14:44:01', '2025-12-08 15:42:37');
...
CREATE TABLE `clients` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `eight_digit_barcode` varchar(8) DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `sales` (
  ...
  `payment_method` enum('efectivo','tarjeta','transferencia','otro','mixto') DEFAULT NULL,
  `card_type` enum('debito','credito') DEFAULT NULL,
  `voucher_folio` varchar(100) DEFAULT NULL,
  `voucher_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `voucher_count` int(11) NOT NULL DEFAULT 0,
  `voucher_folios` text DEFAULT NULL,
  `card_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `cash_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `status` enum('completada','pendiente','cancelada','transferida') DEFAULT 'completada',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `deleted_by_type` varchar(255) DEFAULT NULL,
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES ('1kgz4KlWzkIHPq4SR4EYDtuv0nRsBfZkKJQf7LGu', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765256883);
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES ('R6GBAY3m8JxbE2i734rbm3kC2yyzXD8Rjw084nZE', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '', 1765230159);
...
INSERT INTO `suppliers` (`id`, `name`, `contact_person`, `phone`, `email`, `address`, `tax_id`, `notes`, `is_active`, `deleted_at`, `created_at`, `updated_at`) VALUES (2, 'Sabritas S.A de C.V.', 'Alan Brito', 9932563285, 'thelionblack92@gmail.com', 'Por su casa', 'olskidmnf', 'Prueba', 1, NULL, '2025-10-26 15:47:36', '2025-12-08 14:37:18');
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `profile_picture`, `remember_token`, `created_at`, `updated_at`, `role`, `permissions`, `commission_percentage`, `deleted_at`) VALUES (1, 'Administrador', 'admin@ebc.com', '2025-12-08 12:12:06', '$2y$12$tb.k78Y6jVzkqwegZtlN6exESUdsc2dRygdwSAVsJyU3b29odfCEe', NULL, NULL, '2025-12-08 12:12:06', '2025-12-08 12:12:06', 'admin', '[\"products.view\",\"products.create\",\"products.edit\",\"products.delete\",\"categories.view\",\"categories.create\",\"categories.edit\",\"categories.delete\",\"suppliers.view\",\"suppliers.create\",\"suppliers.edit\",\"suppliers.delete\",\"pos.access\",\"sales_history.view\",\"sales_history.edit\",\"sales_history.cancel\",\"sales_history.delete\",\"cash_control.access\",\"stock_management.access\",\"user_management.view\",\"user_management.create\",\"user_management.edit\",\"user_management.delete\",\"database.access\",\"clients.view\",\"clients.create\",\"clients.edit\",\"clients.delete\",\"services.view\",\"services.create\",\"services.edit\",\"services.delete\",\"coupons.view\",\"coupons.create\",\"coupons.edit\",\"coupons.delete\"]', 0.0000, NULL);
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `profile_picture`, `remember_token`, `created_at`, `updated_at`, `role`, `permissions`, `commission_percentage`, `deleted_at`) VALUES (2, 'Supervisor', 'supervisor@ebc.com', '2025-12-08 12:12:06', '$2y$12$yLvOxEtdpW.cJ4nJ4RgTPe2tv1Gb29BiydjHwsMhUPMjqSqaGfL4S', NULL, NULL, '2025-12-08 12:12:06', '2025-12-08 12:12:06', 'supervisor', '[\"products.view\",\"products.create\",\"products.edit\",\"products.delete\",\"categories.view\",\"categories.create\",\"categories.edit\",\"categories.delete\",\"suppliers.view\",\"suppliers.create\",\"suppliers.edit\",\"suppliers.delete\",\"pos.access\",\"sales_history.view\",\"sales_history.edit\",\"sales_history.cancel\",\"cash_control.access\",\"stock_management.access\",\"user_management.view\",\"user_management.edit\",\"clients.view\",\"clients.create\",\"clients.edit\",\"services.view\",\"services.create\",\"services.edit\",\"services.delete\",\"coupons.view\",\"coupons.create\",\"coupons.edit\",\"coupons.delete\"]', 5.0000, NULL);
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `profile_picture`, `remember_token`, `created_at`, `updated_at`, `role`, `permissions`, `commission_percentage`, `deleted_at`) VALUES (3, 'Usuario', 'usuario@ebc.com', '2025-12-08 12:12:07', '$2y$12$ORI4DJGJ6jieZyvgxVAlBOU13lZLrvRs8p/GmQ4sW1AUOJ/UEcgzy', NULL, NULL, '2025-12-08 12:12:07', '2025-12-08 12:12:07', 'empleado', '[\"products.view\",\"products.create\",\"categories.view\",\"categories.create\",\"suppliers.view\",\"suppliers.create\",\"pos.access\",\"user_management.view\",\"clients.view\",\"services.view\",\"cash_control.access\"]', 9.9999, NULL);
